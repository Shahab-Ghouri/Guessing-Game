	...
	public:
		bool check_pers(){
			...
			if(fileptr){
				...
				cout<<" Is your Character has a famous brother  "<<ans<<"(YES/NO) : ";
				phrase = "DIs your Character has a famous brother "+ans; 
