	...
	public:
		bool check_pers(){
			...
			if(fileptr){
				...
				cout<<" Has your Character has played a role in  "<<ans<<"(YES/NO) : ";
				phrase = "Has your Character has played a role in "+ans; 
				...
				getline(fileptr,ans);
				cout<<" Has your Character won "<<ans<<"(YES/NO) : ";
				phrase = "Has your Character won "+ans; 
				command = "espeak \"" + phrase + "\"";
				char_command = command.c_str();
				system(char_command);
