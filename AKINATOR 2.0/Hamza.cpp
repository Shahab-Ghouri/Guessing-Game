...
class Hamza{
	...
	public:
		bool check_pers(){
			char response[10];
			ifstream fileptr;
			fileptr.open("MALE/hamza.txt");
			if(fileptr){
				getline(fileptr,ans);
				cout<<" Does Your Character Supports "<<ans<<" ? (YES/NO) : ";
				string phrase = "Does Your Character Supports"+ans; 
				...
				phrase = "Is your Character Graduated From "+ans; 
