...
class Hira{
	...
	public:
		bool check_pers(){
			char response[10];
			ifstream fileptr;
			fileptr.open("FEMALE/Hira.txt");
			if(fileptr){
				getline(fileptr,ans);
				cout<<" IS Your Character married to  "<<ans<<" ? (YES/NO) : ";
				string phrase = "IS Your Character married to "+ans; 
				...
				cout<<" Is your Character has won  "<<ans<<"(YES/NO) : ";
				phrase = "Is your Character has won "+ans; 
